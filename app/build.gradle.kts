...
android {
    namespace = "com.example.collegeschedulemahotkinmobil"
    compileSdk {
        version = release(36)
    }

    defaultConfig {
        applicationId = "com.example.collegeschedulemahotkinmobil"
        minSdk = 31
        targetSdk = 36
        versionCode = 1
        versionName = "1.0"
...
dependencies {
    // Основные зависимости проекта (уже будут в файле)
    // ...
